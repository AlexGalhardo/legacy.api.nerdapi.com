...
import { AuthCheckResetPasswordTokenUseCasePort } from "src/UseCases/AuthCheckResetPasswordToken.useCase";
	...
	beforeAll(async () => {
		await Test.createTestingModule({
			...
			providers: [
				...
				{ provide: "AuthCheckResetPasswordTokenUseCasePort", useValue: mock<AuthCheckResetPasswordTokenUseCasePort>() },
			],
		}).compile();
	});
